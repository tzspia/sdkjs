	...
	function ($, window, undefined) {
		...
		asc_CEventsController.prototype.updateScrollSettings = function () {
			...
			if (this.vsbApi) {
				...
				this.reinitScrollY(settings, ws.workbook.getSmoothScrolling() ? ws.getFirstVisibleRowSmoothScroll(true)/AscCommon.AscBrowser.retinaPixelRatio : ws.getFirstVisibleRow(true), ws.getVerticalScrollRange(), ws.getVerticalScrollMax());
